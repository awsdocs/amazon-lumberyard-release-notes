...
+ QT Library
Upgraded the Qt library to version 5.12.4.0 (from version 5.6.2.7). This upgrade includes more than two years of QT bug fixes and new features. Refer to the [Qt release notes](https://doc.qt.io/qt-5/whatsnew512.html) for more information.
