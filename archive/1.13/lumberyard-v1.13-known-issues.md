# Known Issues<a name="lumberyard-v1.13-known-issues"></a>

Lumberyard Beta 1\.13 has the following known issues\. Choose a topic area to learn more\. 

**Topics**
+ [3D Studio Max Tools and Plugin](#studio-max-tools-and-plugin-known-issues-v1.13)
+ [Android](#android-known-issues-v1.13)
+ [Android Studio](#android-studio-known-issues-v1.13)
+ [Animation Editor](#animation-editor-known-issues-v1.13)
+ [Area Objects and Triggers](#area-objects-and-triggers-known-issues-v1.13)
+ [Asset Pipeline](#asset-pipeline-known-issues-v1.13)
+ [Audio](#audio-known-issues-v1.13)
+ [Audiokinetic Wwise and Wwise LTX](#audiokinetic-wwise-and-ltx-known-issues-v1.13)
+ [Audio Components EBus](#audio-components-ebus-known-issues-v1.13)
+ [Audio Proxy Component](#audio-proxy-components-known-issues-v1.13)
+ [Cloud Canvas](#cloud-canvas-known-issues-v1.13)
+ [Cloud Gems](#cloud-gems-known-issues-v1.13)
+ [Cloud Gem Portal](#cloud-gem-portal-known-issues-v1.13)
+ [Component Entity System](#component-entity-system-known-issues-v1.13)
+ [Console Variables](#console-variables-known-issues-v1.13)
+ [CryEngineNonRCModule](#CryEngineNonRCModule-known-issues-v1.13)
+ [CryEntity](#cryentity-known-issues-v1.13)
+ [Data Types](#data-types-known-issues-v1.13)
+ [Decal Component](#decal-component-known-issues-v1.13)
+ [Dedicated Server](#dedicated-server-known-issues-v1.13)
+ [DirectX 12](#directx-12-known-issues-v1.13)
+ [FBX Settings](#fbx-known-issues-v1.13)
+ [Flow Graph](#flow-graph-known-issues-v1.13)
+ [Game Mode Functionality](#game-mode-functionality-known-issues-v1.13)
+ [Game Projects](#game-project-creation-known-issues-v1.13)
+ [Gems](#gems-known-issues-v1.13)
+ [Geppetto](#character-editor-known-issues-v1.13)
+ [Gloss Maps](#gloss-maps-known-issues-v1.13)
+ [Graphics](#graphics-known-issues-v1.13)
+ [Heightmap File](#missing-heightmap-file-known-issues-v1.13)
+ [High DPI Display Support](#high-dpi-display-support-known-issues-v1.13)
+ [Incredibuild](#incredibuild-known-issues-v1.13)
+ [Installation Paths](#installation-paths-known-issues-v1.13)
+ [iOS](#iOS-known-issues-v1.13)
+ [Legacy Sample \(GameSDK\)](#legacy-sample-game-sdk-known-issues-v1.13)
+ [Lens Flare Elements](#lens-flare-elements-known-issues-v1.13)
+ [Linux](#linux-known-issues-v1.13)
+ [Lumberyard Editor](#lumberyard-editor-known-issues-v1.13)
+ [Lumberyard Installation](#lumberyard-installation-known-issues-v1.13)
+ [Lumberyard Setup Assistant](#lumberyard-setup-assistant-known-issues-v1.13)
+ [Lmbr\.exe](#lmbr-exe-known-issues-v1.13)
+ [Lmbr\_test\.cmd Tool](#lmbr_test.cmd-tool-known-issues-v1.13)
+ [Lyzard\.exe](#lyzard.exe-known-issues-v1.13)
+ [macOS](#macOS-known-issues-v1.13)
+ [Mannequin](#mannequin-known-issues-v1.13)
+ [Material Browser](#material-browser-known-issues-v1.13)
+ [Material Editor](#material-editor-known-issues-v1.13)
+ [Maya](#maya-known-issues-v1.13)
+ [Mobile](#mobile-known-issues-v1.13)
+ [Multiplayer Sample](#multiplayer-sample-known-issues-v1.13)
+ [Particle Editor](#particle-editor-known-issues-v1.13)
+ [Perforce Source Control](#perforce-source-control-known-issues-v1.13)
+ [Physics](#physics-known-issues-v1.13)
+ [Profiler](#profiler-known-issues-v1.13)
+ [Project Configurator](#project-configurator-known-issues-v1.13)
+ [Resource Compiler](#resource-compiler-known-issues-v1.13)
+ [SamplesProject](#samples-project-known-issues-v1.13)
+ [Script Canvas](#script-canvas-known-issues-v1.13)
+ [Slices](#slices-known-issues-v1.13)
+ [Starter Game](#starter-game-known-issues-v1.13)
+ [Static Mesh Component](#static-mesh-component-known-issues-v1.13)
+ [Substance Editor](#substance-editor-known-issues-v1.13)
+ [Terrain Textures](#terrain-texture-known-issues-v1.13)
+ [Track View](#track-view-known-issues-v1.13)
+ [Trigger Area Component](#trigger-area-component-known-issues-v1.13)
+ [Twitch ChatPlay and Twitch JoinIn](#twitch-chatplay-and-joinin-known-issues-v1.13)
+ [UI Editor](#ui-canvas-editor-known-issues-v1.13)
+ [Virtual Reality](#virtual-reality-known-issues-v1.13)
+ [Visual Studio Support](#visual-studio-support-known-issues-v1.13)
+ [Waf Build System](#waf-build-system-known-issues-v1.13)
+ [Waterfall Shader](#waterfall-shader-known-issue-v1.13)
+ [Windows Environment Variables](#windows-environment-variables-known-issues-v1.13)
+ [Miscellaneous](#miscellaneous-known-issues-v1.13)

## 3D Studio Max Tools and Plugin<a name="studio-max-tools-and-plugin-known-issues-v1.13"></a>
...
## Android<a name="android-known-issues-v1.13"></a>

Android has the following known issues:
+ Samples Project cannot be built unless you already have the Google Play Billing library installed from a previous version of the Android SDK Manager\. To work around this issue, use **Project Configurator** to disable the IAP gem\.
...
## Android Studio<a name="android-studio-known-issues-v1.13"></a>
...
## Animation Editor<a name="animation-editor-known-issues-v1.13"></a>
...
## Area Objects and Triggers<a name="area-objects-and-triggers-known-issues-v1.13"></a>
...
## Asset Pipeline<a name="asset-pipeline-known-issues-v1.13"></a>
...
## Audio<a name="audio-known-issues-v1.13"></a>
...
## Audiokinetic Wwise and Wwise LTX<a name="audiokinetic-wwise-and-ltx-known-issues-v1.13"></a>
...
## Audio Components EBus<a name="audio-components-ebus-known-issues-v1.13"></a>
...
## Audio Proxy Component<a name="audio-proxy-components-known-issues-v1.13"></a>
...
## Cloud Canvas<a name="cloud-canvas-known-issues-v1.13"></a>
...
## Cloud Gems<a name="cloud-gems-known-issues-v1.13"></a>
...
## Cloud Gem Portal<a name="cloud-gem-portal-known-issues-v1.13"></a>
...
## Component Entity System<a name="component-entity-system-known-issues-v1.13"></a>
...
## Console Variables<a name="console-variables-known-issues-v1.13"></a>
...
## CryEngineNonRCModule<a name="CryEngineNonRCModule-known-issues-v1.13"></a>
...
## CryEntity<a name="cryentity-known-issues-v1.13"></a>
...
+ You must use legacy tools to create roads and rivers, and add other legacy CryEntities\. The legacy tools are disabled by default for new projects\. To enable legacy tools, use the **Project Configurator** to disable the **CryEntity Removal** gem for your project\. For more information, see [CryEntity Removal Gem](https://docs.aws.amazon.com/lumberyard/latest/userguide/gems-system-cryentity-removal-gem.html) in the *Amazon Lumberyard User Guide*\.

## Data Types<a name="data-types-known-issues-v1.13"></a>

The `.cga` and `.anm` data types are deprecated\.

## Decal Component<a name="decal-component-known-issues-v1.13"></a>
...
## Dedicated Server<a name="dedicated-server-known-issues-v1.13"></a>
...
## DirectX 12<a name="directx-12-known-issues-v1.13"></a>
...
## FBX Settings<a name="fbx-known-issues-v1.13"></a>
...
## Flow Graph<a name="flow-graph-known-issues-v1.13"></a>
...
## Game Mode Functionality<a name="game-mode-functionality-known-issues-v1.13"></a>
...
## Game Projects<a name="game-project-creation-known-issues-v1.13"></a>
...
## Gems<a name="gems-known-issues-v1.13"></a>
...
## Geppetto<a name="character-editor-known-issues-v1.13"></a>
...
## Gloss Maps<a name="gloss-maps-known-issues-v1.13"></a>
...
## Graphics<a name="graphics-known-issues-v1.13"></a>
...
## Heightmap File<a name="missing-heightmap-file-known-issues-v1.13"></a>
...
## High DPI Display Support<a name="high-dpi-display-support-known-issues-v1.13"></a>
...
## Incredibuild<a name="incredibuild-known-issues-v1.13"></a>
...
## Installation Paths<a name="installation-paths-known-issues-v1.13"></a>
...
## iOS<a name="iOS-known-issues-v1.13"></a>
...
## Legacy Sample \(GameSDK\)<a name="legacy-sample-game-sdk-known-issues-v1.13"></a>

In a debug build, you might see errors and warnings when loading maps, for example the Woodland map\.

## Lens Flare Elements<a name="lens-flare-elements-known-issues-v1.13"></a>
...
## Linux<a name="linux-known-issues-v1.13"></a>
...
## Lumberyard Editor<a name="lumberyard-editor-known-issues-v1.13"></a>
...
## Lumberyard Installation<a name="lumberyard-installation-known-issues-v1.13"></a>
...
## Lumberyard Setup Assistant<a name="lumberyard-setup-assistant-known-issues-v1.13"></a>
...
## Lmbr\.exe<a name="lmbr-exe-known-issues-v1.13"></a>
...
## Lmbr\_test\.cmd Tool<a name="lmbr_test.cmd-tool-known-issues-v1.13"></a>
...
## Lyzard\.exe<a name="lyzard.exe-known-issues-v1.13"></a>
...
## macOS<a name="macOS-known-issues-v1.13"></a>
...
## Mannequin<a name="mannequin-known-issues-v1.13"></a>
...
## Material Browser<a name="material-browser-known-issues-v1.13"></a>
...
## Material Editor<a name="material-editor-known-issues-v1.13"></a>
...
## Maya<a name="maya-known-issues-v1.13"></a>
...
## Mobile<a name="mobile-known-issues-v1.13"></a>

Do not use spaces when you set the **whitelist** field in the `config.ini` file for the CrySCompileServer\. This prevents validation of the IP address from working\.

## Multiplayer Sample<a name="multiplayer-sample-known-issues-v1.13"></a>
...
## Particle Editor<a name="particle-editor-known-issues-v1.13"></a>
...
## Perforce Source Control<a name="perforce-source-control-known-issues-v1.13"></a>
...
## Physics<a name="physics-known-issues-v1.13"></a>
...
## Profiler<a name="profiler-known-issues-v1.13"></a>
...
## Project Configurator<a name="project-configurator-known-issues-v1.13"></a>
...
## Resource Compiler<a name="resource-compiler-known-issues-v1.13"></a>
...
## SamplesProject<a name="samples-project-known-issues-v1.13"></a>
...
## Script Canvas<a name="script-canvas-known-issues-v1.13"></a>
...
## Slices<a name="slices-known-issues-v1.13"></a>
...
## Starter Game<a name="starter-game-known-issues-v1.13"></a>
...
## Static Mesh Component<a name="static-mesh-component-known-issues-v1.13"></a>

The **Affects Navmesh** check box for the **Static Mesh** component does not affect nav mesh generation\.

## Substance Editor<a name="substance-editor-known-issues-v1.13"></a>
...
## Terrain Textures<a name="terrain-texture-known-issues-v1.13"></a>
...
## Track View<a name="track-view-known-issues-v1.13"></a>
...
## Trigger Area Component<a name="trigger-area-component-known-issues-v1.13"></a>
...
## Twitch ChatPlay and Twitch JoinIn<a name="twitch-chatplay-and-joinin-known-issues-v1.13"></a>
...
## UI Editor<a name="ui-canvas-editor-known-issues-v1.13"></a>
...
## Virtual Reality<a name="virtual-reality-known-issues-v1.13"></a>
...
## Visual Studio Support<a name="visual-studio-support-known-issues-v1.13"></a>
...
## Waf Build System<a name="waf-build-system-known-issues-v1.13"></a>
...
## Waterfall Shader<a name="waterfall-shader-known-issue-v1.13"></a>
...
## Windows Environment Variables<a name="windows-environment-variables-known-issues-v1.13"></a>
...
## Miscellaneous<a name="miscellaneous-known-issues-v1.13"></a>
