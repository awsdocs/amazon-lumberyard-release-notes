# Known Issues<a name="lumberyard-v1.18-known-issues"></a>

Lumberyard Beta 1\.18 has the following known issues\. Choose a topic area to learn more\. 

**Topics**
+ [3D Studio Max Tools and Plugin](#studio-max-tools-and-plugin-known-issues-v1.18)
+ [Android](#android-known-issues-v1.18)
+ [Android Studio](#android-studio-known-issues-v1.18)
+ [Animation Editor](#animation-editor-known-issues-v1.18)
+ [Area Objects and Triggers](#area-objects-and-triggers-known-issues-v1.18)
+ [Asset Builder API](#asset-builder-api-known-issues-v1.18)
+ [Asset Pipeline](#asset-pipeline-known-issues-v1.18)
+ [Audio](#audio-known-issues-v1.18)
+ [Audiokinetic Wwise and Wwise LTX](#audiokinetic-wwise-and-ltx-known-issues-v1.18)
+ [Audio Components EBus](#audio-components-ebus-known-issues-v1.18)
+ [Audio Proxy Component](#audio-proxy-components-known-issues-v1.18)
+ [Cloud Canvas](#cloud-canvas-known-issues-v1.18)
+ [Cloud Gems](#cloud-gems-known-issues-v1.18)
+ [Cloud Gem Portal](#cloud-gem-portal-known-issues-v1.18)
+ [Component Entity System](#component-entity-system-known-issues-v1.18)
+ [Console Variables](#console-variables-known-issues-v1.18)
+ [CryEngineNonRCModule](#CryEngineNonRCModule-known-issues-v1.18)
+ [CryEntity](#cryentity-known-issues-v1.18)
+ [Data Types](#data-types-known-issues-v1.18)
+ [Decal Component](#decal-component-known-issues-v1.18)
+ [Dedicated Server](#dedicated-server-known-issues-v1.18)
+ [DirectX 12](#directx-12-known-issues-v1.18)
+ [Environment Probe Resources](#environment-probe-resources-known-issues-v1.18)
+ [FBX Settings](#fbx-known-issues-v1.18)
+ [Flow Graph](#flow-graph-known-issues-v1.18)
+ [Game Mode Functionality](#game-mode-functionality-known-issues-v1.18)
+ [Game Projects](#game-project-creation-known-issues-v1.18)
+ [Gems](#gems-known-issues-v1.18)
+ [Geppetto](#character-editor-known-issues-v1.18)
+ [Gloss Maps](#gloss-maps-known-issues-v1.18)
+ [Graphics](#graphics-known-issues-v1.18)
+ [GridMate](#gridmate-known-issues-v1.18)
+ [Heightmap File](#missing-heightmap-file-known-issues-v1.18)
+ [High DPI Display Support](#high-dpi-display-support-known-issues-v1.18)
+ [Incredibuild](#incredibuild-known-issues-v1.18)
+ [Installation Paths](#installation-paths-known-issues-v1.18)
+ [iOS](#iOS-known-issues-v1.18)
+ [Launcher Projects](#launcher-projects-known-issues-v1.18)
+ [Lens Flare Elements](#lens-flare-elements-known-issues-v1.18)
+ [Linux](#linux-known-issues-v1.18)
+ [Lmbr\.exe](#lmbr.exe-known-issues-v1.18)
+ [Lumberyard Editor](#lumberyard-editor-known-issues-v1.18)
+ [Lumberyard Installation](#lumberyard-installation-known-issues-v1.18)
+ [Lumberyard Setup Assistant](#lumberyard-setup-assistant-known-issues-v1.18)
+ [Lmbr\.exe](#lmbr-exe-known-issues-v1.18)
+ [Lmbr\_test\.cmd Tool](#lmbr_test.cmd-tool-known-issues-v1.18)
+ [Lyzard\.exe](#lyzard.exe-known-issues-v1.18)
+ [macOS](#macOS-known-issues-v1.18)
+ [Mannequin](#mannequin-known-issues-v1.18)
+ [Material Browser](#material-browser-known-issues-v1.18)
+ [Material Editor](#material-editor-known-issues-v1.18)
+ [Maya](#maya-known-issues-v1.18)
+ [Mobile](#mobile-known-issues-v1.18)
+ [Multiplayer Sample](#multiplayer-sample-known-issues-v1.18)
+ [Particle Editor](#particle-editor-known-issues-v1.18)
+ [Perforce Source Control](#perforce-source-control-known-issues-v1.18)
+ [Physics \(Legacy\)](#physics-known-issues-v1.18)
+ [PhysX](#physx-known-issues-v1.18)
+ [Project Configurator](#project-configurator-known-issues-v1.18)
+ [Resource Compiler](#resource-compiler-known-issues-v1.18)
+ [SamplesProject](#samples-project-known-issues-v1.18)
+ [Script Canvas](#script-canvas-known-issues-v1.18)
+ [Slices](#slices-known-issues-v1.18)
+ [Starter Game](#starter-game-known-issues-v1.18)
+ [Static Mesh Component](#static-mesh-component-known-issues-v1.18)
+ [Substance Editor](#substance-editor-known-issues-v1.18)
+ [Terrain Texture Data](#terrain-texture-data-known-issues-v1.18)
+ [Terrain Texture Dimensions](#terrain-texture-dimensions-known-issues-v1.18)
+ [Track View](#track-view-known-issues-v1.18)
+ [Trigger Area Component](#trigger-area-component-known-issues-v1.18)
+ [Twitch ChatPlay and Twitch JoinIn](#twitch-chatplay-and-joinin-known-issues-v1.18)
+ [Virtual Reality](#virtual-reality-known-issues-v1.18)
+ [Visual Studio Support](#visual-studio-support-known-issues-v1.18)
+ [Waf Build System](#waf-build-system-known-issues-v1.18)
+ [Windows Environment Variables](#windows-environment-variables-known-issues-v1.18)
+ [Miscellaneous](#miscellaneous-known-issues-v1.18)

## 3D Studio Max Tools and Plugin<a name="studio-max-tools-and-plugin-known-issues-v1.18"></a>
...
## Android<a name="android-known-issues-v1.18"></a>
...
## Android Studio<a name="android-studio-known-issues-v1.18"></a>
...
## Animation Editor<a name="animation-editor-known-issues-v1.18"></a>
...
## Area Objects and Triggers<a name="area-objects-and-triggers-known-issues-v1.18"></a>
...
## Asset Builder API<a name="asset-builder-api-known-issues-v1.18"></a>
...
## Asset Pipeline<a name="asset-pipeline-known-issues-v1.18"></a>
...
## Audio<a name="audio-known-issues-v1.18"></a>
...
## Audiokinetic Wwise and Wwise LTX<a name="audiokinetic-wwise-and-ltx-known-issues-v1.18"></a>
...
## Audio Components EBus<a name="audio-components-ebus-known-issues-v1.18"></a>
...
## Audio Proxy Component<a name="audio-proxy-components-known-issues-v1.18"></a>
...
## Cloud Canvas<a name="cloud-canvas-known-issues-v1.18"></a>
...
## Cloud Gems<a name="cloud-gems-known-issues-v1.18"></a>
...
## Cloud Gem Portal<a name="cloud-gem-portal-known-issues-v1.18"></a>
...
## Component Entity System<a name="component-entity-system-known-issues-v1.18"></a>
...
## Console Variables<a name="console-variables-known-issues-v1.18"></a>
...
## CryEngineNonRCModule<a name="CryEngineNonRCModule-known-issues-v1.18"></a>
...
## CryEntity<a name="cryentity-known-issues-v1.18"></a>
...
## Data Types<a name="data-types-known-issues-v1.18"></a>

The `.cga` and `.anm` data types are deprecated\.

## Decal Component<a name="decal-component-known-issues-v1.18"></a>
...
## Dedicated Server<a name="dedicated-server-known-issues-v1.18"></a>
...
## DirectX 12<a name="directx-12-known-issues-v1.18"></a>
...
## Environment Probe Resources<a name="environment-probe-resources-known-issues-v1.18"></a>
...
## FBX Settings<a name="fbx-known-issues-v1.18"></a>
...
## Flow Graph<a name="flow-graph-known-issues-v1.18"></a>
...
## Game Mode Functionality<a name="game-mode-functionality-known-issues-v1.18"></a>
...
## Game Projects<a name="game-project-creation-known-issues-v1.18"></a>
...
## Gems<a name="gems-known-issues-v1.18"></a>
...
## Geppetto<a name="character-editor-known-issues-v1.18"></a>
...
## Gloss Maps<a name="gloss-maps-known-issues-v1.18"></a>
...
## Graphics<a name="graphics-known-issues-v1.18"></a>
...
## GridMate<a name="gridmate-known-issues-v1.18"></a>
...
## Heightmap File<a name="missing-heightmap-file-known-issues-v1.18"></a>
...
## High DPI Display Support<a name="high-dpi-display-support-known-issues-v1.18"></a>
...
## Incredibuild<a name="incredibuild-known-issues-v1.18"></a>
...
## Installation Paths<a name="installation-paths-known-issues-v1.18"></a>
...
## iOS<a name="iOS-known-issues-v1.18"></a>
...
## Launcher Projects<a name="launcher-projects-known-issues-v1.18"></a>

The projects in the `\dev\Code\Launcher` directory will be deprecated and replaced in a future release\.

## Lens Flare Elements<a name="lens-flare-elements-known-issues-v1.18"></a>
...
## Linux<a name="linux-known-issues-v1.18"></a>
...
## Lmbr\.exe<a name="lmbr.exe-known-issues-v1.18"></a>
...
## Lumberyard Editor<a name="lumberyard-editor-known-issues-v1.18"></a>
...
## Lumberyard Installation<a name="lumberyard-installation-known-issues-v1.18"></a>
...
## Lumberyard Setup Assistant<a name="lumberyard-setup-assistant-known-issues-v1.18"></a>
...
## Lmbr\_test\.cmd Tool<a name="lmbr_test.cmd-tool-known-issues-v1.18"></a>
...
## Lyzard\.exe<a name="lyzard.exe-known-issues-v1.18"></a>
...
## macOS<a name="macOS-known-issues-v1.18"></a>
...
## Mannequin<a name="mannequin-known-issues-v1.18"></a>
...
## Material Browser<a name="material-browser-known-issues-v1.18"></a>
...
## Material Editor<a name="material-editor-known-issues-v1.18"></a>
...
## Maya<a name="maya-known-issues-v1.18"></a>
...
## Mobile<a name="mobile-known-issues-v1.18"></a>

Do not use spaces when you set the **whitelist** field in the `config.ini` file for the CrySCompileServer\. This prevents validation of the IP address from working\.

## Multiplayer Sample<a name="multiplayer-sample-known-issues-v1.18"></a>
...
## Particle Editor<a name="particle-editor-known-issues-v1.18"></a>
...
## Perforce Source Control<a name="perforce-source-control-known-issues-v1.18"></a>
...
## Physics \(Legacy\)<a name="physics-known-issues-v1.18"></a>
...
## PhysX<a name="physx-known-issues-v1.18"></a>
...
## Project Configurator<a name="project-configurator-known-issues-v1.18"></a>
...
## Resource Compiler<a name="resource-compiler-known-issues-v1.18"></a>
...
## SamplesProject<a name="samples-project-known-issues-v1.18"></a>
...
## Script Canvas<a name="script-canvas-known-issues-v1.18"></a>
...
## Slices<a name="slices-known-issues-v1.18"></a>
...
## Starter Game<a name="starter-game-known-issues-v1.18"></a>
...
## Static Mesh Component<a name="static-mesh-component-known-issues-v1.18"></a>

The **Affects Navmesh** check box for the **Static Mesh** component does not affect nav mesh generation\.

## Substance Editor<a name="substance-editor-known-issues-v1.18"></a>
...
## Terrain Texture Data<a name="terrain-texture-data-known-issues-v1.18"></a>
...
## Terrain Texture Dimensions<a name="terrain-texture-dimensions-known-issues-v1.18"></a>
...
## Track View<a name="track-view-known-issues-v1.18"></a>
...
## Trigger Area Component<a name="trigger-area-component-known-issues-v1.18"></a>
...
## Twitch ChatPlay and Twitch JoinIn<a name="twitch-chatplay-and-joinin-known-issues-v1.18"></a>
...
## Virtual Reality<a name="virtual-reality-known-issues-v1.18"></a>
...
## Visual Studio Support<a name="visual-studio-support-known-issues-v1.18"></a>
...
## Waf Build System<a name="waf-build-system-known-issues-v1.18"></a>
...
## Windows Environment Variables<a name="windows-environment-variables-known-issues-v1.18"></a>
...
## Miscellaneous<a name="miscellaneous-known-issues-v1.18"></a>
